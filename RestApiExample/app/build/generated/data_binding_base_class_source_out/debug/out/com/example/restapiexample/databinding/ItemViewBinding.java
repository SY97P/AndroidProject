...
public final class ItemViewBinding implements ViewBinding {
  ...
  private ItemViewBinding(@NonNull LinearLayout rootView, @NonNull ImageView itemImage,
  ...
  public static ItemViewBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemViewBinding((LinearLayout) rootView, itemImage, itemName, itemPrice);
    }
